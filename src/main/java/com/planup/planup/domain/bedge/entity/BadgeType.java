...
public enum BadgeType {
    ...
    FEEDBACK_CHAMPION,        // 피드백 챔피언 : 한 주간 반응 버튼 누적 15회 이상
    COMMENT_FAIRY,            // 댓글 요정 : 친구 페이지 댓글 3개 이상
    CHEER_MASTER,             // 응원 마스터 : 응원해요 버튼 3회 이상 클릭
    REACTION_EXPERT,          // 반응 전문가 : 분발해요 버튼 3회 이상 클릭

    // 기록 배지
    START_OF_CHALLENGE,       // 도전의 시작 : 특정 목표 7일 연속 기록
    DILIGENT_TRACKER,         // 성실한 발자국 : 누적 30회 기록
    ROUTINER,                 // 루티너 : 하루에 3개 이상의 목표 기록
    IMMERSION_DAY,            // 몰입의 날 : 3개 목표 100% 완수

    // 사용 배지
    GOAL_COLLECTOR,           // 목표 수집가 : 5개 이상의 목표 생성
    NOTIFICATION_STARTER,     // 알림 개시 : 하루 3번 이상 푸시 클릭
